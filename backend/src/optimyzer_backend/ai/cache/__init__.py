...
Использование::
    ...
    from optimyzer_backend.ai.cache import get_cache, CacheType
...
from optimyzer_backend.ai.cache.canonicalize import (
...
from optimyzer_backend.ai.cache.service import CacheService, get_cache, reset_cache_for_tests
