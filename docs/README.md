...
Этот проект распространяется под лицензией [AGPL-3.0](../LICENSE). Вы можете свободно использовать, изучать и модифицировать код. При распространении модифицированных версий или предоставлении как сервиса (SaaS) вы обязаны открыть исходный код под той же лицензией.

**Коммерческое лицензирование:** если вам нужна лицензия без ограничений AGPL (встраивание в закрытый продукт, коммерческое распространение без открытия кода) — напишите на nazarov.soft@gmail.com.
