...
`,
  ...
  account: {
    freeDescription:
      "Бесплатная версия. Полный доступ к анализу архивов. AI-объяснения операций — 5 в месяц.",
    anonymousDescription:
      "Анализ архивов работает без регистрации. Для AI-объяснений нужна бесплатная регистрация через Yandex — это даёт 5 объяснений в месяц.",
    signInFree: "Зарегистрироваться бесплатно",
    quotaLabel: "AI-объяснений использовано:",
  ...
  onboarding: {
    ...
    welcomeLead:
      "Загрузите архив технологического журнала 1С — получите готовое объяснение проблем производительности на русском.",
    bullets: {
    ...
    empty: {
      ...
      footnote:
        "Анализ работает локально — данные не покидают ваш компьютер. AI-объяснения отправляются в Claude API только по явной кнопке.",
    },
  },
  loginGate: {
    lead: "Войдите чтобы начать. Регистрация бесплатна (через Yandex) — это даёт 5 AI-объяснений в месяц и сохраняет историю на вашем аккаунте.",
    signInYandex: "Войти через Yandex",
    separator: "или",
    alreadyHaveKey: "У меня есть ключ активации",
    activatedToast: "Активирован — добро пожаловать!",
    footnote:
      "Анализ архивов работает локально, данные не покидают компьютер. AI-объяснения отправляются в Claude API только по явной кнопке.",
  },
  paywall: {
    titleFree: "Лимит бесплатных AI-объяснений исчерпан",
    titleCredits: "Кредиты закончились",
    titleNotAuthenticated: "Нужна бесплатная регистрация",
    descriptionExhausted:
      "Вы использовали 5 бесплатных AI-объяснений в этом месяце. Чтобы продолжить — купите кредиты или подключите Pro подписку.",
    descriptionGeneric:
      "Для этого действия нужен Pro или активные кредиты. Pro даёт безлимит AI-объяснений за 2 990 ₽/мес, кредиты — разовые операции.",
    descriptionNotAuthenticated:
      "AI-объяснения доступны после бесплатной регистрации через Yandex — это даёт 5 объяснений в месяц на счёт. Регистрация занимает 10 секунд, оплаты не требуется.",
    upgrade: "Перейти на Pro · 2 990 ₽/мес",
    buyCredits: "Купить кредиты от 299 ₽",
    signInFree: "Зарегистрироваться бесплатно",
    dismiss: "Закрыть",
    footnote: "Анализ архивов работает без ограничений всегда — лимит только на AI-объяснения.",
  },
  errors: {
