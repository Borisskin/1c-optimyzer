...
`,
  ...
  account: {
    ...
    privacy: {
      ...
      hint:
        "Помогает понять какие функции используются. Собираем только метаданные (размеры архивов, переключения экранов). Содержимое запросов, имена баз и AI ответы — никогда.",
    },
  },
  onboarding: {
